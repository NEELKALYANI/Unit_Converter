...
class timer_main : AppCompatActivity() {
    val dbcon: dbconnection = dbconnection(this@timer_main, "dbunitcon", 1)
    ...
    override fun onResume() {
        ...
        var autocompleteTV = findViewById<AutoCompleteTextView>(R.id.autocompletetextview)
            val len = resources.getStringArray(R.array.time_units)
        ...
        var autocompleteTV1 = findViewById<AutoCompleteTextView>(R.id.autocompletetextview1)
            val len1 = resources.getStringArray(R.array.time_units)
    ...
    fun core() {
        ...
        if (actv == "ms")
        {
            ...
            {
                val cursor=dbcon.display_time(2)
            ...
            {
                val cursor=dbcon.display_time(3)
                val data:StringBuffer= StringBuffer()
                if (cursor.count>0)
                {
                    while (cursor.moveToNext())
            ...
            {
                val cursor=dbcon.display_time(4)
                val data:StringBuffer= StringBuffer()
                if (cursor.count>0)
                {
                    while (cursor.moveToNext())
            ...
            {
                val cursor=dbcon.display_time(5)
                val data:StringBuffer= StringBuffer()
                if (cursor.count>0)
                {
                    while (cursor.moveToNext())
            ...
            {
                val cursor=dbcon.display_time(6)
                val data:StringBuffer= StringBuffer()
                if (cursor.count>0)
                {
                    while (cursor.moveToNext())
            ...
            {
                val cursor=dbcon.display_time(7)
                val data:StringBuffer= StringBuffer()
                if (cursor.count>0)
                {
                    while (cursor.moveToNext())
            ...
            {
                val cursor=dbcon.display_time(8)
                val data:StringBuffer= StringBuffer()
                if (cursor.count>0)
                {
                    while (cursor.moveToNext())
        ...
        else if (actv == "sec")
        {
            ...
            else if (actv1 == "min")
            {
                ...
                cursor.close()
                val cursor1=dbcon.display_time(3)
            ...
            else if (actv1 == "hour")
            {
                ...
                cursor.close()
                val cursor1=dbcon.display_time(4)
                val data1:StringBuffer= StringBuffer()
                if (cursor1.count>0)
                {
                    while (cursor1.moveToNext())
            ...
            else if (actv1 == "day")
            {
                ...
                cursor.close()
                val cursor1=dbcon.display_time(5)
                val data1:StringBuffer= StringBuffer()
                if (cursor1.count>0)
                {
                    while (cursor1.moveToNext())
            ...
            else if (actv1 == "week")
            {
                ...
                cursor.close()
                val cursor1=dbcon.display_time(6)
                val data1:StringBuffer= StringBuffer()
                if (cursor1.count>0)
                {
                    while (cursor1.moveToNext())
            ...
            else if (actv1 == "month")
            {
                ...
                cursor.close()
                val cursor1=dbcon.display_time(7)
                val data1:StringBuffer= StringBuffer()
                if (cursor1.count>0)
                {
                    while (cursor1.moveToNext())
            ...
            else if (actv1 == "year")
            {
                ...
                cursor.close()
                val cursor1=dbcon.display_time(8)
                val data1:StringBuffer= StringBuffer()
                if (cursor1.count>0)
                {
                    while (cursor1.moveToNext())
        ...
        else if (actv == "min")
        {
            ...
            {var a:Double = 0.0
                ...
                cursor.close()
                val cursor1=dbcon.display_time(2)
                val data1:StringBuffer= StringBuffer()
                if (cursor1.count>0)
                {
                    while (cursor1.moveToNext())
